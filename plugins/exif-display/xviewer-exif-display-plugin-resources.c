...
# define SECTION __attribute__ ((section (".gresource.xviewer_exif_display_plugin"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[9279]; const double alignment; void * const ptr;}  xviewer_exif_display_plugin_resource_data = { {
...
static GStaticResource static_resource = { xviewer_exif_display_plugin_resource_data.data, sizeof (xviewer_exif_display_plugin_resource_data.data), NULL, NULL, NULL };
G_GNUC_INTERNAL GResource *xviewer_exif_display_plugin_get_resource (void);
GResource *xviewer_exif_display_plugin_get_resource (void)
{
